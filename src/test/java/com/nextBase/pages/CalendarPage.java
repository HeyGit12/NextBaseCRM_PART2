...
public class CalendarPage extends BasePage {
    ...
    public void selectColor(String color){
        ...
        String color1=colour.get(color.toLowerCase());
        otherColor.click();
        customColor.click();
