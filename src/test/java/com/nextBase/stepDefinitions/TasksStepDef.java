...
public class TasksStepDef {
    ...
    public void user_click_under_Activity_stream(String string, String string2) {
    ...
    public void user_enter_following_informations(io.cucumber.datatable.DataTable dataTable) {
        // Write code here that turns the phrase above into concrete actions
